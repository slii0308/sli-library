          ...
          <div class="row mb-3">
            <div class="col-6">
              <div class="form-check">
                <input type="checkbox" class="form-check-input" id="isAustralian" @blur="() => validateAustralian(true)"
                  @change="() => validateAustralian(false)" v-model="formData.isAustralian">
...
const validateAustralian = (blur) => {
  if (!formData.value.isAustralian) {
    errors.value.isAustralian = "You must be an Australian resident to continue.";
  } else {
...
const validateReason = (blur) => {
  if (formData.value.reason.length < 1) {
    if (blur) errors.value.reason = "You must write the reason";
  } else {
